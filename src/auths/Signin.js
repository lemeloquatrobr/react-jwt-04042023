                ...
                signinStatusError
                    ? (
                        <div className="row p-2 border border-danger d-flex justify-content-center">
                            <h4>{signinStatusError ? signinStatusError + ". Try sign in again" : ""}</h4>
                        </div>
                    )
                    : <></>
            }
                            ...
                            <form>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="input-group mb-3">
                                        ...
                                        <span>* Password must be at least 8 characters, one uppercase, one lowercase, one special character and one number</span>
                                    </div>
                                </div>
                            </form>
                        </div>
